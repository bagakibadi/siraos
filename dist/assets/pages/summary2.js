...
$(document).ready(function() {
    ...
    var harga = nyogyakarta_of + nyogyakarta_on + nsurabaya_of + nsurabaya_on + nmedan_of + nmedan_on + nbandung_of + nbandung_on + nmanado_of + nmanado_on + nlombok_of + nlombok_on + nsemarang_of + nsemarang_on + nbatam_of + nbatam_on + njakarta_of + njakarta_on;
    var hargaOnline = nyogyakarta_on + nsurabaya_on + nmedan_on + nbandung_on + nmanado_on + nlombok_on + nsemarang_on + nbatam_on + njakarta_on;
    var hargaOffline = nyogyakarta_of + nsurabaya_of + nmedan_of + nbandung_of + nmanado_of + nlombok_of + nsemarang_of + nbatam_of + njakarta_of;
    var titikHarga = harga.toString().split('').reverse().join('')
    var titikHarga1 = hargaOnline.toString().split('').reverse().join('')
    var titikHarga2 = hargaOffline.toString().split('').reverse().join('')
    var ribuan = titikHarga.match(/\d{1,3}/g);
    var ribuan1 = titikHarga1.match(/\d{1,3}/g);
    var ribuan2 = titikHarga2.match(/\d{1,3}/g);
    ribuan	= ribuan.join('.').split('').reverse().join('')
    ribuan1	= ribuan1.join('.').split('').reverse().join('')
    ribuan2	= ribuan2.join('.').split('').reverse().join('')
    var totalHarga =  document.getElementById("totalHarga").innerHTML = 'Rp.' + ribuan
    var totalHargaOnline = document.getElementById("totalHargaOnline").innerHTML = 'Rp.' + ribuan1
    var totalHargaOffline = document.getElementById("totalHargaOffline").innerHTML = 'Rp.' + ribuan2
